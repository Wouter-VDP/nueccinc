...
def plot_panel_data_mc(
    ...
    for cat in kind_labs.keys():
        ...
        if len(cat_data) > 0 and cat != 6:
            ...
            labels.append(kind_labs[cat] + ": {0:#.0f}".format(sum(weights[-1])))
